...
def check_cleanup_status(file_id):
    ...
    try:
        ...
        return jsonify({
            ...
            "note": "Original images are renamed to normal_ prefix (preserved as visible light photos). IR images are generated by FLIR processing. Both types are kept for report pairing."
        })
